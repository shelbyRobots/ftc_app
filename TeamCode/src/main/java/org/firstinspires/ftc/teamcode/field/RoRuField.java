...
public class RoRuField extends Field
{
    ...
    static final Point2d RBLP = new Point2d("BLLP",  8.25,  8.25);
    static final Point2d RBTP = new Point2d("BLTP",  17.25, 17.25);
    static final Point2d RBM1 = new Point2d("BLM1",  48.0,  24.0);
    static final Point2d RBM2 = new Point2d("BLM2",  36.0,  36.0);
    static final Point2d RBM3 = new Point2d("BLM3",  24.0,  48.0);
    static final Point2d RBDT = new Point2d("BLDT",   0.0,  52.0);
    static final Point2d RBDP = new Point2d("BLDP", -42.0,  55.0);
    static final Point2d RBPP = new Point2d("BLPP",  24.0,  55.0);
    ...
    static final Point2d BRDP = new Point2d("BRDP",  -55,   42.0);
